    ...
    cells = [
        ...
        },
        {
            ...
            "source": [
                ...
                "!pip install -q addict yapf lmdb tb-nightly future facexlib gfpgan opencv-python\n",
                "!pip install -q --no-build-isolation --no-deps basicsr\n\n",
                "# If basicsr is not available, clone and install from source\n",
                "import sys, os\n",
                "try:\n",
                "    import basicsr\n",
                "except ImportError:\n",
                "    print(\"Installing BasicSR from GitHub source...\")\n",
                ...
                "        inf_src = f.read()\n",
                "    if \"register_basicsr_shim\" not in inf_src:\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "except Exception as e:\n",
                "    print(f\"3. BasicSR degradations: NOTICE ({e})\")\n\n",
