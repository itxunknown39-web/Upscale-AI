...
class RRDBNet(nn.Module):
    """Networks consisting of Residual in Residual Dense Block, used in ESRGAN/Real-ESRGAN."""
...
# Register module into sys.modules so 'from basicsr.archs.rrdbnet_arch import RRDBNet' never fails!
